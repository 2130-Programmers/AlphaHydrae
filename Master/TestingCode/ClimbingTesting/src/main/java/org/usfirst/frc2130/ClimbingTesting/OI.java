...
public class OI {
    ...
    public JoystickButton startClimbingButton;
    ...
    public OI() {
        ...
        startClimbingButton = new JoystickButton(joystick, 10);
        startClimbingButton.whenPressed(new ClimbingCommandGroup());
    ...
    public boolean enableClimbingButtonValue() {
